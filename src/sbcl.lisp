...
(defun has-superclass-p (class superclass)
  ...
  (member superclass (sb-mop:compute-class-precedence-list class)))
...
STANDARD-OBJECT."
  (set-difference (sb-mop:compute-class-precedence-list class)
...
including, class CEILING. The class CEILING defaults to
STANDARD-OBJECT."
   (apply #'append (mapcar #'sb-mop:specializer-direct-methods
